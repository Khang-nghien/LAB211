...
public class IOChecking {
    ...
    public boolean checkValidEmail(String input, String msg) {
        
        try {
            
            if (!input.matches("[a-zA-Z0-9@]") || input.matches("@{1}")) {
                throw new Exception(msg);
            }
    ...
    public boolean checkValidAddress(String input, String msg) {
